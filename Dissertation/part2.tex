...
\subsection{PSIICOS как метод оптимальной фильтрации.}\label{sec:psiicos_optimality}
...
сигналов.  Такое усреднение приводило к тому, что векторы с постоянной
разностью фаз усиливали друг друга, а векторы со случайной разностью фаз ---
...
С учетом ограничений на знак $\hat{s}_i$ получим, что $\hat{s}_i = x_i - \alpha$, если
...
Как видим, оптимизационная задача для вложенной итерации свелась к
